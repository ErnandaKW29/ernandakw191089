"""
Django settings for ernandakw191089 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ca_)q=f$!xy2nu*o$+(hz@p1cjh3vblvf4260o_xzmeuk+56-6')
...
ROOT_URLCONF = 'ernandakw191089.urls'
...
WSGI_APPLICATION = 'ernandakw191089.wsgi.application'
